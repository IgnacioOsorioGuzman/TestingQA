 ...
 * @author proyectos33
 */
public class frmEncargadoProyecto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Encargado de Proyecto");
...
//                                        rsPro.getString("idProyecto")+" "+rsPro.getString("codigoBipFach"));
                         ...
                         Logger.getLogger(frmEncargadoProyecto.class.getName()).log(Level.SEVERE, null, ex);
                     }
                    }
...
//                    JOptionPane.showMessageDialog(rootPane, codigo);
    ...
    private void btnBuscarProyectoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarProyectoActionPerformed
         ...
         frmBuscarProyectoEncargadoProyecto miBusqueda = new frmBuscarProyectoEncargadoProyecto(null, closable);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        obteneridproyecto();
        if (IDPROYECTO != 0) {
            frmTareaEncargadoProyecto miBusqueda = new frmTareaEncargadoProyecto();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         obteneridproyecto();
        if (IDPROYECTO != 0) {
            frmDocumentoEncargadoProyecto miBusqueda = new frmDocumentoEncargadoProyecto();
