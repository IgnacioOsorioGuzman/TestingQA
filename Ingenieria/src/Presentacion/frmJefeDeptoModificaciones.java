 ...
 * @author proyectos33
 */
public class frmJefeDeptoModificaciones extends javax.swing.JInternalFrame {
    ...
    public frmJefeDeptoModificaciones() {
        initComponents();
        centrarVentana();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Jefe Depto Modificaciones");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/1371710102_27-Edit Text.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/1371709504_application-vnd.oasis.opendocument.text.png"))); // NOI18N
...
//                                        rsPro.getString("idProyecto")+" "+rsPro.getString("codigoBipFach"));
                         ...
                         Logger.getLogger(frmJefeDeptoModificaciones.class.getName()).log(Level.SEVERE, null, ex);
                     }
                    }
...
//                    JOptionPane.showMessageDialog(rootPane, codigo);
    ...
    private void btnBuscarProyectoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarProyectoActionPerformed
         ...
         frmBuscarProyectoJefeDeptoModificaciones miBusqueda = new frmBuscarProyectoJefeDeptoModificaciones(null, closable);
...
public void permiteModificar() {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        obteneridproyecto();
        if (IDPROYECTO != 0) {
            frmTareaJefeDeptoModificaciones miBusqueda = new frmTareaJefeDeptoModificaciones();

            frmPrincipal.dpnEscritorio.add(miBusqueda);
            miBusqueda.setDatos(misDatos);
            
            miBusqueda.setIdproyecto(IDPROYECTO);
            miBusqueda.setNombrepro(txtNombrePro.getText());
            miBusqueda.setCodigopro(txtCodigoPro.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         obteneridproyecto();
        if (IDPROYECTO != 0) {
            frmDocumentoJefeDeptoModificaciones miBusqueda = new frmDocumentoJefeDeptoModificaciones();
